...
public class calculator extends javax.swing.JFrame {
    ...
    public void enable() {
        ...
        jRadioButton1.setEnabled(false); // disable ON button
        jRadioButton2.setEnabled(true); // enable OFF button
    ...
    public void disable() {
        ...
        jRadioButton1.setEnabled(true); // enable ON button
        jRadioButton2.setEnabled(false); // disable OFF button
    ...
    if (currentText.isEmpty()) {
        // If the text field is empty, append a minus sign
        jTextField1.setText("-");
    } else {
        // Check if the current text ends with a +/- sign
        boolean endsWithPlusMinus = currentText.endsWith("+/-");
        
        // Remove any existing +/- sign from the text
        String newText = currentText.replace("+/-", "");
        
        // Parse the current value
        double currentValue = Double.parseDouble(newText);
        
        // Toggle the sign of the value
        double newValue = -currentValue;
        
        // Append the +/- sign to the text
        if (endsWithPlusMinus) {
            // If the current text already ends with +/-, remove it
